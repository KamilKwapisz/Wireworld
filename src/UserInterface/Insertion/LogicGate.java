...
public class LogicGate {
    ...
    private final  AndInsertion andInsertion;
    private final  NandInsertion nandInsertion;
    private final  NotInsertion notInsertion;
    private final OrInsertion orInsertion;
    private final XorInsertion xorInsertion;
    private InsertionFlag insertionFlag;
    private int x,y;
    private final Tile[][] grid;
    
    public LogicGate(Tile[][] grid){
